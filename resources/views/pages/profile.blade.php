        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-gray-900 border border-yellow-500/10 rounded-xl p-6">
                ...
                <div class="space-y-2 text-gray-300">
                    <p>Online Points:
                        <span class="text-white font-semibold">{{ $user->onlinePoints }}</span>
                    </p>

                    <p>Boss Points:
                        <span class="text-white font-semibold">{{ $user->bossPoints }}</span>
                    </p>

                    <p>Guild ID:
                        <span class="text-white font-semibold">{{ $user->guildID }}</span>
                    </p>

                    <p>Guild Rank:
                        <span class="text-white font-semibold">{{ $user->guildRankName }}</span>
                    </p>
                </div>
